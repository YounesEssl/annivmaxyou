      ...
      <div className="w-full max-w-6xl mx-auto relative z-10">
        <div ref={ref} className={`${isVisible ? 'animate-fade-in-up' : 'opacity-0'} duration-600`}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center" style={{ marginBottom: '10rem' }}>
            {/* Texte à gauche */}
            <div className="animate-fade-in-left delay-100 space-y-8 order-2 lg:order-1">
            ...
            {/* Image à droite */}
            <div className="animate-fade-in-right delay-300 relative order-1 lg:order-2">
          ...
          {/* Liste des alcools */}
          <div className="animate-fade-in-up delay-400 space-y-6" style={{ marginBottom: '8rem' }}>
            {alcoholItems.map((item) => (
              <div
                key={item.name}
                className="flex items-center gap-4 animate-fade-in-left delay-200"
              >
          ...
          {/* Divider */}
          <div className="animate-scale-in delay-500" style={{ marginBottom: '8rem' }}>
          ...
          {/* Softs */}
          <div className="animate-fade-in-up delay-600 text-center" style={{ marginBottom: '8rem' }}>
            ...
            <div className="flex flex-wrap justify-center gap-6 items-center">
              ...
              <span className="text-xl sm:text-2xl md:text-3xl font-light text-white/50 animate-scale-in delay-200">
                etc…
              </span>
            </div>
          </div>
